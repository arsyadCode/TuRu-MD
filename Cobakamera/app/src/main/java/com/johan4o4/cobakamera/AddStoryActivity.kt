...
import com.johan4o4.cobakamera.databinding.ActivityAddStoryBinding
import com.johan4o4.cobakamera.ml.ASLmodel
...
class AddStoryActivity: AppCompatActivity()  {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.uploadButton.setOnClickListener {
            ...
            val model = ASLmodel.newInstance(this)
            ...
            if(bitmap != null) {
                ...
                Log.d("shape", "output : ${outputFeature0.floatArray[0]}")
...
//
//            bitmap = binding.previewImageView.drawable.toBitmap()
//            var resize: Bitmap = Bitmap.createScaledBitmap(bitmap!!, 64, 64, true)
//            val model = ASLmodel.newInstance(this)
